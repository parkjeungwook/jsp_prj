  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row">
				...
				<div>
				<jsp:useBean id="ud" class="day0622.UserDTO" scope="session"/>
				<!-- setter method 호출 -->
				<jsp:setProperty property="name" name="ud" value="윤인성"/>
				<jsp:setProperty property="email" name="ud" value="yonn@test.com"/>
				<jsp:setProperty property="age" name="ud" value="31"/>
				</div>
				이름 : <span><jsp:getProperty property="name" name="ud"/></span>
				이메일 : <span><jsp:getProperty property="email" name="ud"/></span>
				나이 : <span><jsp:getProperty property="age" name="ud"/></span>
				
				id가 객체명이므로 script에서 해당 객체를 사용할 수 있다.
