...
<script type="text/javascript">
	...
	$(function(){
		...
		function addText() {
			cnt++;
			$("#text").append(`<input type="text" name="text" value="테스트${cnt}">`);
		}//addText
</script>
</head>
<body>
		...
		<div id="myCarousel" class="carousel slide mb-6"
			...
			<div class="row featurette">
				...
				<div style="padding-left: 150px;">
					<form action="getArrParameterFormProcess.jsp" method="get" name="frm" class="frm" onsubmit="return false">
						<table>
							<tr>
								<th colspan="2"><h3>name 속성의 값이 중복될 때 HTML Form Control</h3></th>
							</tr>
							<tr>
								<td>text</td>
								<td>
