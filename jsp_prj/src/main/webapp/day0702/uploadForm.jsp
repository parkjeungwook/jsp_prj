...
<body>
	...
	<main>
		<div style="margin-top: 50px">
			<form action="<%= request.getContextPath() %>/day0702/uploadProcess.jsp" method="post" enctype="multipart/form-data" name="frm" id="frm">
			<label>업로더</label><input type="text" name="uploader"/>
			<input type="file" name="upfile" id="upfile" />		
			<input type="submit" value="파일 업로드" class="btn btn-outline-light"/>			
			</form>
		</div>
		<!-- /.container -->
		<!-- FOOTER -->
