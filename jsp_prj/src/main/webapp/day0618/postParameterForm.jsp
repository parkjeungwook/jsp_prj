		...
		<div id="myCarousel" class="carousel slide mb-6"
			...
			<div class="row featurette">
				...
				<div style="padding-left: 150px;">
					<form action="postParameterFormProcess.jsp" method="post" name="frm" class="frm" onsubmit="return false">
						<table>
							<tr>
								<th colspan="2"><h3>name 속성의 값이 유일한 HTML Form Control(POST방식 요청)</h3></th>
							</tr>
							<tr>
								<td>text</td>
							...
							<tr>
								<td>check</td>
								<td>
									<input type="checkbox" name="agree" value="Y" checked="checked">동의
								</td>
							</tr>
							<tr>
								<td>select</td>
