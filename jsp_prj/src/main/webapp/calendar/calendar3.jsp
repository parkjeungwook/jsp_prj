...
%>
	...
	<div id="calHeader">
		<a href="#" onclick="moveCal(<%=prevMonth%>,<%=prevYear%>); return false;" title="이전월">&lt;&lt;</a>

		<a href="calendar3.jsp" title="오늘">
			<span class="calTitle"><%=nowYear%>.<%=nowMonth%></span>
		</a>

		<a href="#" onclick="moveCal(<%=nextMonth%>,<%=nextYear%>); return false;" title="다음월">&gt;&gt;</a>
	</div>
